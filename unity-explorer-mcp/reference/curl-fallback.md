...
Every tool is reachable over plain HTTP, just without the schemas surfacing as native tools — so nothing validates your arguments before the server sees them.
